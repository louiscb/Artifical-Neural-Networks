...
def main():
    ...
    model = create_and_assess_model(train_set, validation_set, [3, 3], learning_rate=.01, alpha=.9, regularization=0.)
...
def create_and_assess_model(train_set, val_set, hidden_layer_sizes, learning_rate, alpha, regularization):
    ...
    prefix = "noisy_lr={}_hidden_layers={}_lambda={}".format(learning_rate, hidden_layer_sizes, regularization)
