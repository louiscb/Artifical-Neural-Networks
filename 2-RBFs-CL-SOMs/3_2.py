...
f = open("part1results/results3_2_comparing_effect_of_noise.txt", 'w')
f.write('\nwth noise after 20 epochs, mse on testset is\n')
...
f.write('\nwithout noise, after 20 epochs mse on testset is\n')

network2 = RBFNetwork(n_inputs=1, n_rbf=40, n_outputs=1, rbf_var=0.1)
x_train = np.arange(0, 2*np.pi, 0.1)
